...
func Test_bch_new(t *testing.T) {
	address := "neo:pz5gaqmezdq3uajw82rt9zth8st76cn5kvrlrxyt6j"
...
func Test_bch_address(t *testing.T) {
	cashAddress := "neo:qpm2qsznhks23z7629mms6s4cwef74vcwvy22gdx6a"
...
func Test_AddressCheck(t *testing.T) {
	...
	testnet_bch_cash := "neo:qqqs9ll3c0wl32mfsvhezqzhaxdv3nemcc988w0rxn"
